...
public class HangMan {
    ...
    String[] wordsInArray = {//This array contains all the possible words
            "american",
            "blue",
            "brie",
            "burrata",
    ...
    public void run(){
        for (String i:wordsInArray){//This loop transfers the array into an arraylist for easier data storage
            words.add(i);
        }
